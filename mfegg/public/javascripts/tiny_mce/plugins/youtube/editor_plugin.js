		...
		switch (type) {
			...
			case "get_from_editor":
				...
				while ((startPos = content.indexOf('<img', startPos+1)) != -1) {
					...
					embedHTML += '<object class="youtube" type="application/x-shockwave-flash" style="width: ' + attribs["width"] + 'px; height:' + attribs["height"] + 'px;" data="' + flash_mov + '">';
					embedHTML += '<param name="movie" value="' + flash_mov + '" />';
					embedHTML += '<param name="wmode" value="transparent" />';
					embedHTML += '<!--<embed src="' + flash_mov + '" type="application/x-shockwave-flash" wmode="transparent" type="application/x-shockwave-flash" width="' + attribs["width"] + '" height="' + attribs["height"] + '"></embed>-->';
					embedHTML += '</object>';
